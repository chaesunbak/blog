...
[참고자료 1 MDN 콜백함수](https://developer.mozilla.org/ko/docs/Glossary/Callback_function)

[참고자료 2 MDN 함수](https://developer.mozilla.org/ko/docs/Glossary/Function)

[참고자료 3 위키백과 : 익명 함수](https://ko.wikipedia.org/wiki/%EC%9D%B5%EB%AA%85_%ED%95%A8%EC%88%98)

[참고자료 4 위키백과 : 람다 대수](https://ko.wikipedia.org/wiki/%EB%9E%8C%EB%8B%A4_%EB%8C%80%EC%88%98)

[참고자료 5 Stack Overflow : Whats the difference between predicate and callback function in typescript?](https://stackoverflow.com/questions/76067709/whats-the-difference-between-predicate-and-callback-function-in-typescript)

[참고자료 6 MDN 클로저](https://developer.mozilla.org/ko/docs/Web/JavaScript/Guide/Closures)

[참고자료 7 Toast UI : 자바스크립트에서 팩토리 함수란 무엇인가?](https://ui.toast.com/posts/ko_20160905)
